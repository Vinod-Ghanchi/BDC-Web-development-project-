...
<div class="carousel-inner">
  <div class="carousel-item active">
    <img src="https://ichef.bbci.co.uk/news/976/cpsprodpb/182FF/production/_107317099_blooddonor976.jpg" class="d-block w-100" alt="...">
  </div>
  <div class="carousel-item">
    <img src="https://stanfordbloodcenter.org/wp-content/uploads/2020/06/Blood-facts_10-illustration-graphics__canteen.png" class="d-block w-100" alt="...">
  </div>
  <div class="carousel-item">
    <img src="https://www.paho.org/sites/default/files/styles/max_1500x1500/public/2021-06/2021blood-donor-digital-sticker-eng_0.png?itok=jXSvtZAD" class="d-block w-100" alt="...">
  </div>
</div>
...
<div class="container col-xxl-8 px-4 py-5 compatibility">
  <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
    <div class="col-10 col-sm-8 col-lg-6">
      <img src="https://previews.123rf.com/images/udaix/udaix1706/udaix170600052/80631822-kompatibilit%C3%A4tstabelle-f%C3%BCr-blutgruppen-mit-allen-positiven-und-negativen-blutgruppen-aus-der-hervorg.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="1500" height="700" loading="lazy">
    </div>
    <div class="col-lg-6">
      <h1 class="display-5 fw-bold lh-1 mb-3">Compatibility.</h1>
      <p class="lead">Everyone who is eligible can donate blood, but depending on your blood type, you're only able to receive certain types of blood, plasma or platelets.There are eight different blood types, and they're not always compatible with each other. Interestingly, people who have O-negative blood are considered universal donors for the entire population.</p>
...
<div class="px-4 py-5 my-5 text-center" id="learnmore">
    ...
    <div class="col-lg-9 mx-auto">
      ...
      <p class="lead mb-9"> One donation can save multiple lives. Here are the facts:</p>
      <ul>
 <li>Just <b>1 donation</b> can save up to <b>3 lives.</b></li>
 <li>The average red blood cell transfusion is <b>3 pints</b> (or 3 whole-blood donations).</li>
 <li>More than <b>1 million</b> people every year are diagnosed with cancer for the first time. Many of them will need blood—sometimes daily—during chemotherapy.</li>
 <li>More than <b>38,000 blood donations</b> are needed every day.</li>
 <li><b>Type O-negative</b> whole blood can be transfused to people with any blood type, but this type of blood is rare, and supplies of it are low.</li>
 <li><b>Type AB plasma</b> can be transfused to patients with all other blood types, but it's also in <b>short supply</b>.</li>
</ul>
...
<!-- Footer -->
    <button class="myBtn"><a href="#top" style="color: white">Top</a></button>
   </div>
